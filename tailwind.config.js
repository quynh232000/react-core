...
export default withMT({
  content: [
    ...
    "./resources/**/*.js",
    "./resources/**/*.jsx",
    // Cực kỳ quan trọng: Quét toàn bộ file React trong các Module
    "./Modules/**/resources/js/Pages/**/*.jsx",
    "./Modules/**/resources/js/Components/**/*.jsx",
    "./Modules/**/resources/js/Layouts/**/*.jsx",
  ],
  theme: {
    extend: {
      colors: {
          // Map `primary-*` của app sang màu `purple-*` để Material Tailwind
          // (dùng các class `bg-purple-500`, `text-purple-500`, ...) đồng bộ primary-500.
          purple: {
            50: "#F5F3FE",
            100: "#EDE8FD",
            200: "#DACEFA",
